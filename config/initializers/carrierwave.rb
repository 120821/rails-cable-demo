CarrierWave.configure do |config|
  ...
  config.aliyun_access_id = "LTAI5tHHnvG1bYfPyjtBQF9E"
  config.aliyun_access_key = 'AHlTFqpmfjVAsrUvavNlmVMnsMHYSo'
  # 你需要在 Aliyum OSS 上面提前创建一个 Bucket
  config.aliyun_bucket = "120821"
  ...
  config.aliyun_host = "https://120821.oss-cn-beijing.aliyuncs.com"
